...
It takes a reference to a \hyperlink{class_camera}{Camera}, and two vec3s, and uses the information to adjust the \hyperlink{class_camera}{Camera}'s \-\_\-rotation.


\begin{DoxyParams}{Parameters}
{\em Wii\-Camera} & The camera to adjust the \-\_\-rotation of. \\
\hline
