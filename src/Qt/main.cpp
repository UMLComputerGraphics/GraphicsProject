...
void init() {
  ...
  shader[0] = Angel::InitShader( "../Binaries/shaders/vMONOLITH.glsl",
                                 "../Binaries/shaders/fMONOLITH.glsl" );
  shader[1] = Angel::InitShader( "../Binaries/shaders/vterrain.glsl", 
				 "../Binaries/shaders/ftex.glsl" );
  shader[2] = Angel::InitShader( "../Binaries/shaders/vParticle.glsl",
                                 "../Binaries/shaders/fFlameParticle.glsl" );
