...
class CButtonBase {
public:
  CButtonBase( void *ButtonsPtr, void *ButtonsHeldPtr,
...
public:
  ...
  CNunchukButtons( void *ButtonsPtr, void *ButtonsHeldPtr,
                   void *ButtonsReleasedPtr );

private:
  short Cast( void *Ptr ) {
    return (short) (*((byte *) (Ptr)));
  } // Inlined using the different type.
};
...
public:
  ...
  CClassicButtons( void *ButtonsPtr, void *ButtonsHeldPtr,
                   void *ButtonsReleasedPtr );
};
...
public:
  ...
  CGH3Buttons( void *ButtonsPtr, void *ButtonsHeldPtr,
               void *ButtonsReleasedPtr );
};
...
class CGyroscope {
public:
  CGyroscope( struct ang3s_t* RawGyro, struct ang3s_t* CalGyro,
...
class CWeightSensor {
public:
  CWeightSensor( struct pressure_t* RawWeight, struct pressure_t* LowCalWeight,
  ...
  void GetRawWeight( int& TopLeft, int& TopRight, int& BottomLeft,
                     int& BottomRight );
  void GetWeight( float& TotalWeight, float& TopLeft, float& TopRight,
                  float& BottomLeft, float& BottomRight );
  void GetLowCalWeight( int& TopLeft, int& TopRight, int& BottomLeft,
                        int& BottomRight );
  void GetMediumCalWeight( int& TopLeft, int& TopRight, int& BottomLeft,
                           int& BottomRight );
  void GetHighCalWeight( int& TopLeft, int& TopRight, int& BottomLeft,
                         int& BottomRight );
...
public:
  enum BarPositions {
    BAR_ABOVE = WIIC_IR_ABOVE, BAR_BELOW = WIIC_IR_BELOW
  };

  enum AspectRatioSelections {
    ASPECT_4_3 = WIIC_ASPECT_4_3, ASPECT_16_9 = WIIC_ASPECT_16_9
  };
...
public:
  ...
  inline void LogStop() {
    logger.SetLogLevel( WIIC_LOG_STOP );
  }
  inline void Log();

  /* Timestamp methods */
  inline struct timeval GetTimestamp() const {
    return mpWiimotePtr->timestamp;
  }
  ...
  void ReadData( unsigned char *Buffer, unsigned int Offset,
                 unsigned int Length );
...
public:
  ...
  std::vector< CWiimote >& FindAndConnect( int timeout = 5, bool rumbleAck =
                                               true,
