...
static string MLAlgName[] = { "KNN", "Bayes", "SVM", "DT", "ANN", "Boost", "RT",
                              "None" };
...
public:
  enum type {
    KNN, Bayes, SVM, DT, ANN, Boost, RT, NONE, NUMTYPES
  };
  MLAlg( type t = KNN );
  ...
  inline void setCategoryNames( const vector< string >& names ) {
    categoryNames = names;
  }
