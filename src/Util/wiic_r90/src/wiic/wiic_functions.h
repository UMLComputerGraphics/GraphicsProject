...
extern "C" {
  ...
  WIIC_EXPORT extern void wiic_motion_sensing( struct wiimote_t* wm,
                                               int status );
  WIIC_EXPORT extern int wiic_read_data( struct wiimote_t* wm, byte* buffer,
                                         unsigned int offset,
                                         unsigned short len );
  WIIC_EXPORT extern int wiic_write_data( struct wiimote_t* wm,
                                          unsigned int addr, byte* data,
                                          byte len );
  WIIC_EXPORT extern void wiic_status( struct wiimote_t* wm );
  WIIC_EXPORT extern struct wiimote_t* wiic_get_by_id( struct wiimote_t** wm,
                                                       int wiimotes, int unid );
  WIIC_EXPORT extern int wiic_set_flags( struct wiimote_t* wm, int enable,
                                         int disable );
  WIIC_EXPORT extern float wiic_set_smooth_alpha( struct wiimote_t* wm,
                                                  float alpha );
  WIIC_EXPORT extern void wiic_set_orient_threshold( struct wiimote_t* wm,
                                                     float threshold );
  WIIC_EXPORT extern void wiic_resync( struct wiimote_t* wm );
  WIIC_EXPORT extern void wiic_set_accel_threshold( struct wiimote_t* wm,
                                                    int threshold );
  WIIC_EXPORT extern void wiic_update_timestamp( struct wiimote_t* wm );
  
  /* connect.c */
  WIIC_EXPORT extern int wiic_find( struct wiimote_t** wm, int max_wiimotes,
                                    int timeout );
  WIIC_EXPORT extern int wiic_load( struct wiimote_t** wm );
  WIIC_EXPORT extern int wiic_connect( struct wiimote_t** wm, int wiimotes,
                                       int autoreconnect );
  WIIC_EXPORT extern int wiic_connect_single( struct wiimote_t* wm,
                                              char* address,
                                              int autoreconnect );
  ...
  WIIC_EXPORT extern void wiic_set_ir_vres( struct wiimote_t* wm,
                                            unsigned int x, unsigned int y );
  WIIC_EXPORT extern void wiic_set_ir_position( struct wiimote_t* wm,
                                                enum ir_position_t pos );
  WIIC_EXPORT extern void wiic_set_aspect_ratio( struct wiimote_t* wm,
                                                 enum aspect_t aspect );
  WIIC_EXPORT extern void wiic_set_ir_sensitivity( struct wiimote_t* wm,
                                                   int level );
  
  /* nunchuk.c */
  WIIC_EXPORT extern void wiic_set_nunchuk_orient_threshold(
      struct wiimote_t* wm, float threshold );
  WIIC_EXPORT extern void wiic_set_nunchuk_accel_threshold(
  ...
  /* motionplus.c */
  WIIC_EXPORT extern void wiic_set_motion_plus( struct wiimote_t* wm,
                                                int status );
  WIIC_EXPORT extern void wiic_calibrate_motion_plus(
      struct motion_plus_t* mp );
  WIIC_EXPORT extern void wiic_set_mp_threshold( struct wiimote_t* wm,
                                                 int threshold );
