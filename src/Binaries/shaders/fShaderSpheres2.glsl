...
vec3 computeLightShadow(in Intersection isect)
{
	...
	vec3 lightPoint = (ModelView * vec4(5,5,5,0)).xyz;
    Ray ray;
	ray.org = p;
...
void main()
{
    sphere[0].c   = (ModelView * vec4(-1.0, 0.0, -5.0, 1.0)).xyz;
    sphere[0].r   = 0.5;
    sphere[0].col = vec3(1,0.3,0.3);
    sphere[1].c   = (ModelView * vec4(0.0, 1.0, -4.0, 1.0)).xyz;
    sphere[1].r   = 0.5;
    sphere[1].col = vec3(0.3,1,0.3);
    sphere[2].c   = (ModelView * vec4(1.0, 0.0, -3.0, 1.0)).xyz;
    sphere[2].r   = 0.5;
